      ...
      <div className="w-full max-w-md z-10">
        <div className="bg-card rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
          ...
          <div className="px-10 pt-12 pb-8 text-center">
            ...
            <h2 className="text-3xl font-display font-bold text-secondary-900 tracking-tight">Bienvenue</h2>
            <p className="text-secondary-500 mt-3 font-sans text-sm">Connectez-vous pour accéder à vos rapports d'intervention.</p>
          </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <a href="#" className="text-xs font-semibold text-primary-700 hover:text-primary-800">Mot de passe oublié ?</a>
                </div>
                <div className="relative group">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-secondary-500 group-focus-within:text-primary-700 transition-colors">
