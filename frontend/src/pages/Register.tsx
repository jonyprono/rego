...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-xl z-10 px-4 sm:px-0 my-8">
        <div className="bg-card rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 overflow-hidden">
          
          {/* Header */}
          <div className="px-6 sm:px-10 pt-10 sm:pt-10 pb-6 text-center">
            ...
            <p className="text-secondary-500 mt-2 sm:mt-3 font-sans text-sm">Rejoignez-nous pour gérer vos rapports d'intervention de manière professionnelle.</p>
          </div>
